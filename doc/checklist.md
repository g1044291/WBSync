...
- [x] 5-4 [タスクのD&D並び替え](task/task5-4.md)
...
- [x] 7-6 [親タスク日付の動的計算](task/task7-6.md)

## 大タスク8：ガントチャート描画
- [x] 8-1 [時間軸レンダリング](task/task8-1.md)
- [x] 8-2 [タスクバー描画](task/task8-2.md)
- [x] 8-3 [スケール切り替え](task/task8-3.md)
- [x] 8-4 [左右ペインのスクロール同期](task/task8-4.md)
- [x] 8-5 [全体休日列のハイライト](task/task8-5.md)
- [x] 8-6 [個人休日行のハイライト](task/task8-6.md)
- [x] 8-7 [行ホバーハイライトの左右同期](task/task8-7.md)

## 大タスク9：結合・品質
- [x] 9-1 [画面遷移の繋ぎ込み](task/task9-1.md)
- [x] 9-2 [バリデーション整備](task/task9-2.md)
- [x] 9-3 [エラーハンドリング](task/task9-3.md)
